	...
	return (
		<>
			<Modal show={show} onHide={handleCloseModal}>
				...
				<Modal.Footer>
					<Button className="my-button font-monospace" form="register-form" type="submit" onClick={() => trigger()}>
						Register
					</Button>
					<Button className="my-button font-monospace" onClick={handleCloseModal}>
						Close
					</Button>
				</Modal.Footer>
			</Modal>
